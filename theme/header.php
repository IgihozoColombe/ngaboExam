...
<html lang="en">
  ...
  <head>
    ...
    <title>Online Furniture Information Management System</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-expand-xl .navbar-nav .nav-link bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php" style="color: #ffff00  "><u><b>Online Furniture Information Management System</b></u></a>
...
<?php 
          ...
          <?php  endwhile;
          echo '</li></ul>
          <a class="nav-link" href="#" id="userDropdown"><i class="fas fa-user-circle ">'.$_SESSION['fname'].' '.$_SESSION['lname'].'</i></a>';

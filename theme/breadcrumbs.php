...
echo '<ol class="breadcrumb">
  ...
  <div class="container"> 
    <div class="section-title">
       <marquee behavior="alternate"><h3><b>WELCOME TO FURNTURE MANAGEMENT SYSTEM</b></b></h3></marquee>
      <hr>
         ...
         <div class="row">
                ...
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
                        <span class="fa-stack fa-5x">
                            <img src="theme/carousel/1.png" alt="..." style="width:100%"> 
                        </span>
                    </div>
                ...
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
                        <span class="fa-stack fa-5x">
                         ...
                         <img src="theme/carousel/2.png" alt="..." style="width:100%">
                        </span>
                        </span>
                    </div>
                    <div class="panel-body">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
                        <span class="fa-stack fa-5x">
                             <img src="theme/carousel/3.png" alt="..." style="width:100%">
                                  </span>
                                    </div>
                    <div class="panel-body">
                        <h4>Steel Chair</h4>
                ...
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
                        <span class="fa-stack fa-5x">
                            <img src="theme/carousel/4.png" alt="..." style="width:100%">
                        </span>
                    </div>
                    <div class="panel-body">
                        <h4>Sofa</h4>
                ...
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
                        <span class="fa-stack fa-5x">
                            <img src="theme/carousel/5.png" alt="..." style="width:100%">
                        </span>
                    </div>
                    <div class="panel-body">
                        <h4>Wooden Table</h4>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
                        <span class="fa-stack fa-5x">
                            <img src="theme/carousel/6.png" alt="..." style="width:100%">
                        </span>
...
echo'
 <ol class="breadcrumb">
  ...
  <div class="container"> 
    <div class="section-title">
       <marquee behavior="alternate"><h3>ADD TO CART WHAT YOU BUY</h3></marquee>
      <hr>

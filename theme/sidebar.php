...
if($_SESSION['position']=='Admin') {
    echo '<div id="wrapper">
      ...
      <ul class="sidebar navbar-nav" style="background-image: linear-gradient(brown,#ff9900);">
        ...
        <li class="nav-item">
          <a class="nav-link"style="color: #9FC4F5" href="charts.php">
     ...
     <!----   <li class="nav-item dropdown">
        ...
        <li class="nav-item">
          <a class="nav-link"style="color: #9FC4F5" href="Shipperstable.php">
            <i class="fas fa-shipping-fast"></i>
            <span>Shippers</span></a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link"style="color: #9FC4F5" href="Suppliertable.php">
